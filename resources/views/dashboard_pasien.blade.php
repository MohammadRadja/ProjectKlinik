                    ...
                    <div class="container-fluid auth-page pasien-daftar logged">
                        <div class="row">
                            <div class="col-lg-4 left-wrap">
                                <div class="image img-fluid" style="background-image: url(images/masthead-home.jpg)"></div>
                            </div>
                            <div class="col-lg-8 right-wrap">
                                <div class="form-wrap">
                                    ...
                                    <div class="box rounded-5 p-4">
                                        ...
                                        <h1 class="logo fw-bold">Klinik Umum Al-Fiat Prakter 24Jam</h1>
                                        <div class="akun my-3 d-flex justify-content-between align-items-center">
                                            <span class="text-muted">Selamat Datang,
                                                <em>{{ Auth::guard('pasien')->user()->name }}</em></span>
                                            <a class="btn btn-sm btn-outline-danger"
                                                onclick="$('#logout').submit()">Keluar</a>
                                        </div>
                                        <div class="page-tabs">
                                            <ul class="nav nav-tabs nav-justified mb-3">
                                                <li class="nav__item"><a class="nav-link active" href="#reservasi"
                                                        data-toggle="tab">Reservasi</a></li>
                                                <li class="nav__item"><a class="nav-link" href="#reservasid"
                                                        data-toggle="tab">Panggil Dokter</a></li>
                                                <li class="nav__item"><a class="nav-link" href="#antrian"
                                                        data-toggle="tab">Antrian</a></li>
                                                <li class="nav__item"><a class="nav-link" href="#rekam_medis"
                                                        data-toggle="tab">Rekam Medis</a></li>
                                                <li class="nav__item"><a class="nav-link" href="#pembayaran"
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="reservasid">
                                                <p style="max-width: 450px;color: #333A47;margin: 1rem auto;">Panggilan
                                                    ...
                                                    dilakukan oleh pasien yang terdaftar dan harus berdomisili di Tangerang.
                                                </p>
                                                <form class="form--add-contact" method="POST" target="_blank"
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-8">
                                                            <div class="panel-body reserv">
                                                                ...
                                                                <div class="form-group">
                                                                    <label> Alamat</label>
                                                                    <textarea class="form-control form-control-sm" type="text" name="alamat">{{ Auth::guard('pasien')->user()->alamat }}</textarea>
                                                                </div>
                                                                <div class="form-action"><a
                                                                        class="btn btn-primary btn-block"
                                                                        href="javascript:;"
