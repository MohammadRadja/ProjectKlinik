...
<body>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="text-align: right;vertical-align: top">
                <br>
                Klinik Umum Al-Fiat Prakter 24Jam<br>
                Alamat :<br>
                Jl. Beringin Raya, RT.001/RW.007, Nusa Jaya, Kec. Karawaci, Kota Tangerang, Banten
                15116
                <br>
                Telpon :<br>
                089898989<br>
    ...
    <table style="width: 60%;float: left">
        ...
        <tr>
            <td>
                Klinik Umum Al-Fiat Prakter 24Jam
            </td>
        </tr>
        <tr>
            <td>
                BCA Klinik Umum Al-Fiat Praktek 24Jam <br>
