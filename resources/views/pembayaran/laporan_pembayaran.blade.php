                ...
                <nav class="navbar navbar-light" style="width: 100%">
                    <div class="col-md-4">
                        <a class="navbar-brand" href="{{ url('/dashboard') }}" style="color: white !important">
                            KLINIK UMUM AL-FIAT PRAKTEK 24JAM
                        </a>
                    </div>
                ...
                <table style="width: 100%">
                    <tr style="vertical-align: top">
                        <td style="width: 25%;padding-top: 1rem">
                            <img src="https://user-images.githubusercontent.com/56387755/176904318-20fdfb9d-aa19-4112-b681-5a3b0db332fb.png"
                                style="width: 40%">
                        </td>
                        <td style="width: 50%; text-align: center;vertical-align: top;padding-top: 1rem">
                            <h2 style="margin-bottom: 0px;padding: 0px ;margin: 0px"><b>KLINIK UMUM AL-FIAT PRAKTEK
                                    24JAM</b></h2>
                            <span style="font-size: 15px;text-align: center">
                                Jl. Beringin Raya, RT.001/RW.007, Nusa Jaya, <br> Kec. Karawaci, Kota Tangerang,
                                <br> Banten 15116 <br>
                            </span>
                        </td>
                        <td style="width: 25%;padding-top: 1rem">
...
<div id="modal-tambah-data" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <form class="modal-content" id="form-data" action="{{ route('laporan-pembayaran') }}">
